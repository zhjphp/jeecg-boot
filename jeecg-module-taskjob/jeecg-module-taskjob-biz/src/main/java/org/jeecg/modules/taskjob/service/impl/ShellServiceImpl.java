...
//            String[] cmdArray = new String[]{program, "./" + shellFileFullName};
//            Process process = new ProcessBuilder(cmdArray).directory(new File(codePath)).redirectErrorStream(true).start();
